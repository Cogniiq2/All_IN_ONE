...
import { LinkDocumentButton } from '@/components/admin/finance/controls';
import { RegisterDocumentForm } from '@/components/admin/finance/document-forms';
            ...
            <div>
              {mayEdit ? (
                <Section title="Register a document" meta="hashed on arrival" id="upload">
                  <div className="pt-3">
                    <RegisterDocumentForm counterparties={result.data.counterparties.map((c) => ({ id: c.id, name: c.name }))} />
                  </div>
                </Section>
