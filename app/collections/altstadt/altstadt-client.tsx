...
export default function AltstadtClient() {
  const { t } = useI18n();
  const residencesList = getResidencesByCollection('innenstadt');

  const bullets = [
    t('collectionPage.altstadtBullet1'),
    t('collectionPage.altstadtBullet2'),
    t('collectionPage.altstadtBullet3'),
  ];
        ...
        <SectionReveal>
          <div className="max-w-2xl mb-14">
            ...
            <p className="text-muted-foreground leading-relaxed">
              {t('collectionPage.altstadtIntro')}
            </p>
          </div>
        </SectionReveal>
